...
class G1_29_ArmController:
    def __init__(self):
        ...
        while not self.lowstate_buffer.GetData():
            time.sleep(0.01)
            logger.info("[G1_29_ArmController] Waiting to subscribe dds...")
    ...
    def _subscribe_motor_state(self):
        logger.info(f"running subscriber thread ")
        while True:
    ...
    def _ctrl_motor_state(self):
        while True:
            ...
            # logger.info(f"arm_velocity_limit:{self.arm_velocity_limit}")
